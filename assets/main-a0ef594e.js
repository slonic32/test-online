import{a as l,b as T}from"./vendor-0363fca5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerpolicy&&(n.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?n.credentials="include":e.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(e){if(e.ep)return;e.ep=!0;const n=s(e);fetch(e.href,n)}})();class p{constructor(){const t=document.querySelectorAll(".js-object");for(let s=0;s<t.length;s++)"dataset"in t[s]&&"jsname"in t[s].dataset&&(this[t[s].dataset.jsname]=t[s])}refresh(){for(var t in this)t in this&&delete this[t];const s=document.querySelectorAll(".js-object");for(let a=0;a<s.length;a++)"dataset"in s[a]&&"jsname"in s[a].dataset&&(this[s[a].dataset.jsname]=s[a])}}const w={_baseURL:"https://food-boutique.b.goit.study/api",_categoriesURL:"/products/categories",_productsURL:"/products",_popularURL:"/products/popular",_discountURL:"/products/discount",_subscriptionURL:"/subscription",_orderURL:"/orders",categories:async function(){try{return(await l.get(this._baseURL+this._categoriesURL)).data}catch(t){throw t}},popular:async function(){try{return(await l.get(this._baseURL+this._popularURL)).data}catch(t){throw t}},discount:async function(){try{return(await l.get(this._baseURL+this._discountURL)).data}catch(t){throw t}},product:async function(t){try{return(await l.get(this._baseURL+this._productsURL+`/${t}`)).data}catch(s){throw s}},products:async function(t={}){try{const s={params:t};return(await l.get(this._baseURL+this._productsURL,s)).data}catch(s){throw s}},subscribe:async function(t){try{const s={email:t};return(await l.post(this._baseURL+this._subscriptionURL,s)).data}catch(s){throw s}},order:async function(t){try{return(await l.post(this._baseURL+this._orderURL,t)).data}catch(s){throw s}}},u={_filterID:"filter-project-Bpfbt9js",_cartID:"cart-project-Bpfbt9js",_save:function(t,s){try{const a=JSON.stringify(s);localStorage.setItem(t,a)}catch(a){throw a}},_load:function(t){try{const s=localStorage.getItem(t);return s===null?{}:JSON.parse(s)}catch(s){throw s}},_delete:function(t){try{localStorage.removeItem(t)}catch(s){throw s}},saveFilter:function(t){this._save(this._filterID,t)},loadFilter:function(){return this._load(this._filterID)},deleteFilter:function(){this._delete(this._filterID)},saveCart:function(t){this._save(this._cartID,t)},loadCart:function(){return this._load(this._cartID)},deleteCart:function(){this._delete(this._cartID)}};function D(o,t){const s=T.create(o,{onShow:e=>{document.addEventListener("keydown",a),e.element().querySelector(t).onclick=e.close},onClose:()=>{document.removeEventListener("keydown",a)}});function a(e){e.key==="Escape"&&s.close()}s.show()}const q="/test-online/assets/icons-5dbc4c13.svg#close-icon",O="/test-online/assets/icons-5dbc4c13.svg#shopping-cart-icon";async function N(o,t){const a=o.target.closest(t).dataset.productid,{name:e,desc:n,img:r,category:h,price:c,size:f,popularity:R}=await w.product(a);let I="Add to",L=u.loadCart();"products"in L&&L.products.findIndex(m=>m.productId===a)!==-1&&(I="Remove from");const x=`<div class="container">
  <div class="modal-product">
      ...
      <div class="modal-product-bottom">
    ...
    </div>`;D(x,".js-modal-close"),document.querySelector(".js-modal-product-cart").addEventListener("click",$=>{const m=$.target.closest(".modal-product-cart");let d=u.loadCart(),j=!0;if("products"in d){const k=d.products.findIndex(P=>P.productId===a);k!==-1&&(d.products.splice(k,1),m.querySelector(".baskettext").innerHTML="Add to",j=!1)}j&&("products"in d?d.products.push({productId:a,amount:1}):d={email:"",products:[{productId:a,amount:1}]},m.querySelector(".baskettext").innerHTML="Remove from"),u.saveCart(d)})}const B="/test-online/assets/icons-5dbc4c13.svg#discount-icon",E="/test-online/assets/icons-5dbc4c13.svg#discount-cart",C="/test-online/assets/icons-5dbc4c13.svg#discount-checked";async function A(){const t=new p;t.discountList.innerHTML="";const s=await w.discount(),a=[];let e=0;for(s.length<2?e=s.length:e=2;e>0;e--){let c=Math.floor(Math.random()*s.length);a.push(s[c]),s.splice(c,1)}let n=u.loadCart();const r=[];"products"in n&&(n=n.products,n.forEach(c=>r.push(c.productId)));const h=[];a.forEach(c=>{let f=E;r.includes(c._id)&&(f=C),h.push(`
        <li class="discount-list-item discount-show" data-productId="${c._id}">
            <svg width="60" height="60" class="discount-icon discount-show"  data-productId="${c._id}">
              <use href="${B}" class="discount-show"  data-productId="${c._id}"></use>
            </svg>
        ...
        `)}),t.discountList.insertAdjacentHTML("beforeend",h.join(""))}function H(o){let t=u.loadCart(),s=!0;"products"in t&&t.products.forEach(a=>{if(a.productId===o){s=!1;return}}),s&&("products"in t?t.products.push({productId:o,amount:1}):t={email:"",products:[{productId:o,amount:1}]},u.saveCart(t))}function F(o,t){const s=new p;s[`${t}${o}`].href.baseVal===`${E}`&&(s[`${t}${o}`].href.baseVal=`${C}`)}function z(o){o.target.classList.contains("discount-buy")?(H(o.target.dataset.productid),F(o.target.dataset.productid,"discountIcon")):o.target.classList.contains("discount-show")&&N(o,".discount-show")}const i={openModalBtn:document.querySelector('[data-action="open-modal"]'),closeModalBtn:document.querySelector('[data-action="close-modal"]'),backdrop:document.querySelector(".js-backdrop"),modalImg:document.querySelector(".modal__food-basket"),modalInner:document.querySelector(".modal-inner")},S=document.querySelector(".footer-form"),J="Escape";function b(){window.addEventListener("keydown",M),i.closeModalBtn.addEventListener("click",g),i.backdrop.addEventListener("click",U),document.body.classList.add("show-modal")}function g(){window.removeEventListener("keydown",M),i.closeModalBtn.removeEventListener("click",g),i.backdrop.removeEventListener("click",U),document.body.classList.remove("show-modal")}function U(o){o.currentTarget===o.target&&g()}function M(o){o.code===J&&g()}async function K(o){o.preventDefault();const t=o.target.elements.email.value;console.log(t);const s={email:t},a={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)};await fetch("https://food-boutique.b.goit.study/api/subscription",a).then(e=>{if(e.json(),console.log(e),e.status===409){b(),i.modalImg.style.display="none",i.modalInner.innerHTML=`
        ...
        </div>`;return}if(e.status===201){b(),i.modalImg.style.display="block",i.modalInner.innerHTML=`
        <div class="modal__title--wrap">
        <p class="modal__title">
      ...
      <div class="modal__description--wrap">
        <p class="modal__description">
          ...
          `,S.reset();return}b()}).catch(e=>console.log(e.message))}let v,_,y;async function V(){v=new p,v.PopularList.innerHTML="",_=await w.popular(),Y()}function W(o){return o.map(({_id:t,img:s,name:a,category:e,size:n,popularity:r})=>` 
...
//# sourceMappingURL=main-a0ef594e.js.map
